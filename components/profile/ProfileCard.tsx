    ...
    <div className="bg-primary text-background">
      <div className="px-4 py-6">
        <div className="flex items-center gap-4">
          ...
          {/* 设置按钮 */}
          <button className="p-2 bg-background/20 rounded-full">
      ...
      <div className="px-4 pb-4 flex gap-3">
        <Button variant="outline" className="flex-1 bg-background/20 text-background border-background/30">
          编辑资料
        </Button>
        <Button
          variant="outline"
          className="flex-1 bg-background/20 text-background border-background/30"
          onClick={onLogout}
        >
